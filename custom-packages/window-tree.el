;;; window-tree.el --- Save and restore window layouts  -*- lexical-binding: t; -*-
...
(defun my-window-tree/parse-window-tree (tree)
  "Parse the given window TREE structure.

 replacing unreadable objects with placeholders."
  (let ((pattern "#<\\([^>]+\\)>"))
