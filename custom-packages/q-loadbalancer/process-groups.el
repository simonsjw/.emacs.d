...
(let ((process-name "loadbalancer")
      ...
      (secondary-threads
       (string-to-number
        (or (getenv "kdb_loadBalancer_secondary_threads") "0")))
      (process-count
       (string-to-number
        (or (getenv "kdb_loadBalancer_default_num") "1")))
      (conda-environment
...
(let ((process-name "gateway")
      ...
      (secondary-threads
       (string-to-number
        (or (getenv "kdb_gateway_secondary_threads") "0")))
      (process-count
       (string-to-number
        (or (getenv "kdb_gateway_default_num") "1")))
      (conda-environment
...
(let ((process-name "process_secondary")
      ...
      (secondary-threads
       (string-to-number
        (or (getenv "kdb_process_secondary_secondary_threads") "0")))
      (process-count
       (string-to-number
        (or (getenv "kdb_process_secondary_default_num") "1")))
      (conda-environment
...
(let ((process-name "service_equities")
      ...
      (secondary-threads
       (string-to-number
        (or (getenv "kdb_service_equities_secondary_threads") "4")))
      (process-count
       (string-to-number
        (or (getenv "kdb_service_equities_default_num") "1")))
      (conda-environment
...
(let ((process-name "service_ai")
      ...
      (secondary-threads
       (string-to-number
        (or (getenv "kdb_service_ai_secondary_threads") "4")))
      (process-count
       (string-to-number
        (or (getenv "kdb_service_ai_default_num") "1")))
      (conda-environment
...
(let ((process-name "service_reddit")
      ...
      (secondary-threads
       (string-to-number
        (or (getenv "kdb_service_reddit_secondary_threads") "4")))
      (process-count
       (string-to-number
        (or (getenv "kdb_service_reddit_default_num") "1")))
      (conda-environment
