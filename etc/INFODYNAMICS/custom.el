(custom-set-variables
 ...
 '(package-selected-packages
   '(aggressive-indent anaconda-mode apache-mode auctex-latexmk auto-compile
                       bookmark+ cape cargo cargo-mode cargo-transient
                       ...
                       geiser-guile geiser-racket git-modes google-contacts
                       helpful ibuffer-vc imenu-list info+ jump marginalia
                       modus-themes nerd-icons-completion nerd-icons-corfu
                       nerd-icons-dired nerd-icons-ibuffer no-littering numpydoc
 ...
 '(package-vc-selected-packages
   '((treesit-fold :url "https://github.com/emacs-tree-sitter/treesit-fold.git")
     ...
     (bookmark+ :url "https://github.com/emacsmirror/bookmark-plus.git")
     (auto-compile :url "https://github.com/emacscollective/auto-compile.git")))
