...
(custom-set-variables
 ...
 '(insert-shebang-file-types
   '(("py" . "python") ("groovy" . "groovy") ("fish" . "fish") ("robot" . "robot")
     ("rb" . "ruby") ("lua" . "lua") ("php" . "php") ("sh" . "bash")
     ("pl" . "perl") ("raku" . "raku") ("q" . "q") ("sh" . "sh")))
 ...
 '(package-selected-packages
   '(aggressive-indent anaconda-mode apache-mode auctex-latexmk cape cargo
                       ...
                       docker docker-compose-mode dot-env-mode dotenv-mode
                       dumb-jump eldoc-box elisp-demos flycheck-clojure
                       flymake-markdownlint flymake-shellcheck geiser-guile
                       geiser-racket git-modes google-contacts helpful
                       ibuffer-vc imenu-list info+ insert-shebang jump
