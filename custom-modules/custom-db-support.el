;;; custom-db-support.el --- database support for emacs setup   -*- lexical-binding: t; -*-
...
;; configure formatting SQL wiht pg_formatter and 
...
(provide 'custom-db-support)
;;; custom-db-support.el ends here
