...
(declare-function my-theme-support/tone-down-fringes "custom-system-tools")
          ...
          (lambda ()
            ...
            (custom-set-faces
             ...
             `(modus-themes-heading-1
               ((t (:foreground ,info-theme-white-grey :weight Bold
                                :height 140 :family "arial"))) t)

             `(modus-themes-heading-2
               ((t (:foreground ,info-theme-white-grey :weight Bold
                                :height 130 :family "arial"))) t)

             `(modus-themes-heading-3
               ((t (:foreground ,info-theme-white-grey :weight Bold
                                :height 120 :family "arial"))) t)
            ...
            (defface my-font-faces/mode-line-clicked
              `((t :inherit 'mode-line-highlight :background ,info-theme-sharp-lime))
...
;;; custom-theme-support.el ends here
                                                                                  ...
                                                                                  ; LocalWords:  rustc
                                                                                  ; LocalWords:  defvars
                                                                                  ; LocalWords:  rainstormstudio
                                                                                  ; LocalWords:  dired
                                                                                  ; LocalWords:  LuigiPiucco
                                                                                  ; LocalWords:  formatters
                                                                                  ; LocalWords:  corfu
                                                                                  ; LocalWords:  fontification ibuffer COLOR
