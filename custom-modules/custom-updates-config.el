;;;; custom-updates-config.el --- Provides automatic update behavior for the configuration.  -*- lexical-binding: t; -*-
...
(provide 'custom-updates-config)
;;; custom-updates-config.el ends here
