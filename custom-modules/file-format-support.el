;;; file-format-support.el --- YAML, JSON, TOML, sudoers, csv, dotenv, and vlf. -*- lexical-binding: t; -*-
...
;; YAML, JSON, TOML, sudoers, csv, dotenv, and vlf editing helpers.
;; Load from `init.el' after `logging-config'.
;;
;; Map:
...
;;   Load-phase: ide
;;   Keymaps:    none
;;   Docs:       docs/file-format-support.org
;;   OS:         taplo yaml-language-server vscode-json-languageserver visudo

;;; Code:
(require 'path-support)
(require 'logging-config)
(log/debug :fn 'file-format-support
           :msg "Starting load of the file-format-support module."
           :obj t)
...
(defun my-file-format/yaml-ts-mode-setup ()
...
(defun my-file-format/json-ts-mode-setup ()
...
(add-hook 'json-ts-mode-hook #'my-file-format/json-ts-mode-setup)
...
(defun my-file-format/toml-ts-mode-setup ()
...
(add-hook 'toml-ts-mode-hook #'my-file-format/toml-ts-mode-setup)
(add-to-list 'auto-mode-alist '("\\.toml\\'\\|\\.TOML\\'" . toml-ts-mode))


(log/debug :fn 'file-format-support
           :msg "Finishing load of the file-format-support module."
           :obj t)


(provide 'file-format-support)
;;; file-format-support.el ends here
