;;; lang-bash.el -*- lexical-binding: t; -*-

;;; Commentary:

;; A config for editing Bash scripts with enhanced syntax highlighting
;; via Treesit (bash-ts-mode), LSP code completion via Eglot, and
;; on-the-fly syntax checking with Flymake.
;;
;; Prerequisites:
;;
;; - Emacs with Tree-sitter installed and the Bash grammar for Tree-sit.
...
;; Assuming bash-ts-mode is set up to be used with Tree-sit
