...
;; (load (expand-file-name "docs/crafted-docs.el" user-emacs-directory))
...
(defvar crafted-docs-directory (expand-file-name "docs/" user-emacs-directory)
...
(defvar crafted-docs-export-use-user-emacs-directory nil
...
If `crafted-docs-export-use-user-emacs-directory' is non-nil and
  ...
  (interactive
   (list
    (cond ((file-exists-p "./crafted-docs.el") ".")
          ((and crafted-docs-export-use-user-emacs-directory
